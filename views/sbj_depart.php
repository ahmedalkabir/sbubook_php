...
<html dir="rtl">
    ...
    <body id="bkg">
        ...
        <?php require_once($this->navigation); ?>
            <div class="uk-container uk-container-expand list-book">
                <div class="uk-section uk-section-secondary uk-light">
                    <div class="uk-container">
                        <ul class="uk-breadcrumb">
                            <li><a href=<?php echo BASE_URL . "department"; ?>>الرئيسية</a></li>
                            <li><a href="#"><?= $this->Name_Department ?></a></li>
                        </ul>
                        ...
                        <div class="uk-overflow-auto">
                            <table class="uk-table uk-table-striped uk-table-hover">
                                ...
                                <tbody>
                                <?php foreach($this->Sbj_Department as $key => $value): ?>
                                    <tr>
                                        <td><a href=<?php echo BASE_URL ."subject/".$value['code_subject']?>><?= $value['code_subject']?></a></td>
                                        <td><a href=<?php echo BASE_URL ."subject/".$value['code_subject']?>><?= $value['name_subject']?></td>
                                        <td><?= $value['units']?></td>
